...
- **موضع `platform/`**: مُضيف/نشر (تطبيق أندرويد APK)، يبقى خارج `features/`؛ جاهزيّة النشر على Google Play (توقيع إصدار + AAB + أيقونة…) شريحة مُضيف منفصلة موثَّقة في [جاهزيّة-النشر-والمُضيف-android](./جاهزيّة-النشر-والمُضيف-android.md).
