...
سجلّ خطط التنفيذ التشغيليّة للمشاريع المفتوحة في منظومة لغة **ص**. لكلّ مشروع مجلد كامل (خطة، تقارير، مخططات، أصول).

| المشروع | الحالة | المالك | مستودع الكود |
|---|---|---|---|
| [mihrab-editor](./mihrab-editor/) | `مقترح` | فريق الأدوات | _لم يُنشأ بعد_ |
...
عند إضافة مجلد مشروع، أضف صفًّا هنا يطابق بطاقة المشروع في `projects/<اسم>/README.md` (الحالة والمالك ورابط الكود).
